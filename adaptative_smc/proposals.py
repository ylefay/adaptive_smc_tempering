...
def cov_estimate(particles: ArrayLike, weights: ArrayLike) -> ArrayLike:
    ...
    """
    N = particles.shape[0]
    mu_hat = jnp.mean(particles, axis=0)
...
def build_gaussian_rwmh_cov_proposal(_, particles, log_weights, i):
    return build_gaussian_rwmh_cov_proposal_gamma(2.38, particles, log_weights, i)


def build_gaussian_rwmh_cov_proposal_gamma(gamma, particles, log_weights, i):
