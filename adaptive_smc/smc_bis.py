...
class GenericAdaptiveWasteFreeTemperingSMC:
    ...
    def estimate_expectation_criteria_fun(self, state, i):
        ...
        def fun(param):
            ...
            log_acceptance_ratio = jax.lax.min(0., log_current_tgt_density_new_proposed_particles - log_target_density_at_t_fn_particles + log_weights_proposal_inv - log_weights_proposal)
