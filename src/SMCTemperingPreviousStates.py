...
class TemperedSMC:
    ...
    def adaptative_schedule_tempered_smc(self, key: jax.Array, init_particles: jnp.ndarray,
        ...
        def body_fn(carry, _):
            ...
            new_state, info = kernel(subkey, state, cumul_states, i, **extra_parameters_step)
        ...
        (_, result, _), chain = jax.lax.scan(body_fn, (
            0, init_state, init_cumul_states), jnp.zeros(num_tempering_steps))
        return result, chain
    ...
    def fixed_schedule_tempered_smc(self, key: jax.Array, init_particles: jnp.ndarray, initial_parameter_value: Dict,
        ...
        (_, result, _), chain = jax.lax.scan(body_fn, (0, init_state, init_cumul_states), lmbda_schedule)
        return result, chain
