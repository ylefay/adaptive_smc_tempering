...
import src.SMC.online_waste_free.SMCTempering as SMC
import src.SMC.online_waste_free.proposals as proposals
...
def exp(num_particles):
    ...
    config = {'num_particles': num_particles, 'num_tempering_steps': num_tempering_steps,
              ...
              'kernel_id': 'adapt_esjd_gaussian_AR_proposal',
